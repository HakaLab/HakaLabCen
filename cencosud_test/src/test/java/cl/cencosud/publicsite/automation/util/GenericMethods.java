package cl.cencosud.publicsite.automation.util;
...
public final class GenericMethods {
	...
	public static void screenShot(String nombre) {
		try {
			File screenshot = ((TakesScreenshot) BaseFlow.driver).getScreenshotAs(OutputType.FILE);
...
//		try {
//			WebDriverWait wait = new WebDriverWait(AplicationRunning.driverWeb, 5);
