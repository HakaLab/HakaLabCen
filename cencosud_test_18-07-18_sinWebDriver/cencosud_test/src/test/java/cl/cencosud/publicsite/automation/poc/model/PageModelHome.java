...
//CARRO COMPRA
	...
	//CHECKOUT NOVIOS.
	@FindBy(how = How.XPATH, using = "ingresar id codigo novios")
	private WebElement CheckOutTxtCodigoNovios;
	@FindBy(how = How.XPATH, using = "ingresar btn novios")
	private WebElement CheckOutBtnNovios;
	
	//CHECKOUT METODOS PAGO
	@FindBy(how = How.XPATH, using = "//*[contains(@class,'saved-card')]")
	private List<WebElement> checkOutListTarjetas;
	@FindBy(how = How.XPATH, using = "//*[@id=\"main\"]/div/div/div[2]/div[5]/div[2]/dl[1]/dd")
	...
	@FindBy(how = How.XPATH, using = "//*[@id=\"main\"]/div/div/div[2]/div[7]/div[2]/div[4]/h4/p/strong")
	private WebElement checkoutTotalCompraCencosud;
...
//	private WebElement checkoutBtnCreditCard;
	...
	//GiftCard
	@FindBy(how = How.XPATH, using = "//*[contains(@href,'#accordionGiftCard')]")
	private WebElement checkoutBtnIngresaDatosGiftCard;
	@FindBy(how = How.XPATH, using = "//*[contains(@id,'dwfrm_giftcard_giftcardnumber')]")
	private WebElement checkoutTxtCodigoGiftcard;
	@FindBy(how = How.XPATH, using = "//*[contains(@id,'dwfrm_giftcard_giftcardpassword')]")
	private WebElement checkoutTxtPasswordGiftcard;
	@FindBy(how = How.NAME, using = "dwfrm_giftcard_apply")
	private WebElement checkoutBtnAplicarGiftcard;
	...
	private WebElement checkoutBtnRealizarPedidoCreditCard;
	...
	@FindBy(how = How.XPATH, using = "//*[contains(@id,'dwfrm_billing_paymentMethods_cencosudCard_firstName')]")
	...
	private WebElement checkoutBtnRealizarPedidoCencoCard;
	...
	@FindBy(how = How.ID, using = "TBK_TIPO_TARJETA")
	private WebElement checkoutBtnRadioWebPayRedCompra;
	@FindBy(how = How.ID, using = "TBK_BANCO")
	private WebElement checkoutSelectWebPayEmisor;
	@FindBy(how = How.ID, using = "TBK_NUMERO_TARJETA")
	private WebElement checkoutInputNumTarjetaWebPay;
	@FindBy(how = How.ID, using = "button")
	private WebElement checkoutBtnPagarWebPay;
    @FindBy(id = "rutClient")
   ...
   //PDP FRAME BONIFICACION
	...
	@FindBy(how = How.ID, using ="shipping-method-5")
	private WebElement EntregaRadioDespachoDomicilioPreSale;
...
//CHECKOUT METODOS DE PAGO
	...
	public WebElement getCheckoutTotalCompraCencosud() {
		return checkoutTotalCompraCencosud;
	}

	public void setCheckoutTotalCompraCencosud(WebElement checkoutTotalCompraCencosud) {
		this.checkoutTotalCompraCencosud = checkoutTotalCompraCencosud;
	}
	...
	public WebElement getCheckoutBtnIngresaDatosGiftCard() {
		return checkoutBtnIngresaDatosGiftCard;
	}

	public void setCheckoutBtnIngresaDatosGiftCard(WebElement checkoutBtnIngresaDatosGiftCard) {
		this.checkoutBtnIngresaDatosGiftCard = checkoutBtnIngresaDatosGiftCard;
	}

	public WebElement getCheckoutTxtCodigoGiftcard() {
		return checkoutTxtCodigoGiftcard;
	}

	public void setCheckoutTxtCodigoGiftcard(WebElement checkoutTxtCodigoGiftcard) {
		this.checkoutTxtCodigoGiftcard = checkoutTxtCodigoGiftcard;
	}

	public WebElement getCheckoutTxtPasswordGiftcard() {
		return checkoutTxtPasswordGiftcard;
	}

	public void setCheckoutTxtPasswordGiftcard(WebElement checkoutTxtPasswordGiftcard) {
		this.checkoutTxtPasswordGiftcard = checkoutTxtPasswordGiftcard;
	}

	public WebElement getCheckoutBtnAplicarGiftcard() {
		return checkoutBtnAplicarGiftcard;
	}

	public void setCheckoutBtnAplicarGiftcard(WebElement checkoutBtnAplicarGiftcard) {
		this.checkoutBtnAplicarGiftcard = checkoutBtnAplicarGiftcard;
	}

	public WebElement getEntregaRadioDespachoDomicilioPreSale() {
		return EntregaRadioDespachoDomicilioPreSale;
	}

	public void setEntregaRadioDespachoDomicilioPreSale(WebElement entregaRadioDespachoDomicilioPreSale) {
		EntregaRadioDespachoDomicilioPreSale = entregaRadioDespachoDomicilioPreSale;
	}
	...
	public WebElement getCheckoutBtnRadioWebPayRedCompra() {
		return checkoutBtnRadioWebPayRedCompra;
	}

	public void setCheckoutBtnRadioWebPayRedCompra(WebElement checkoutBtnRadioWebPayRedCompra) {
		this.checkoutBtnRadioWebPayRedCompra = checkoutBtnRadioWebPayRedCompra;
	}

	public WebElement getCheckoutSelectWebPayEmisor() {
		return checkoutSelectWebPayEmisor;
	}

	public void setCheckoutSelectWebPayEmisor(WebElement checkoutSelectWebPayEmisor) {
		this.checkoutSelectWebPayEmisor = checkoutSelectWebPayEmisor;
	}

	public WebElement getCheckoutInputNumTarjetaWebPay() {
		return checkoutInputNumTarjetaWebPay;
	}

	public void setCheckoutInputNumTarjetaWebPay(WebElement checkoutInputNumTarjetaWebPay) {
		this.checkoutInputNumTarjetaWebPay = checkoutInputNumTarjetaWebPay;
	}

	public WebElement getCheckoutBtnPagarWebPay() {
		return checkoutBtnPagarWebPay;
	}

	public void setCheckoutBtnPagarWebPay(WebElement checkoutBtnPagarWebPay) {
		this.checkoutBtnPagarWebPay = checkoutBtnPagarWebPay;
	}
	
	
	

//	public WebElement getCheckoutInputRutClienteTransbank() {
//		return checkoutInputRutClienteTransbank;
//	}
//
//	public void setCheckoutInputRutClienteTransbank(WebElement checkoutInputRutClienteTransbank) {
//		this.checkoutInputRutClienteTransbank = checkoutInputRutClienteTransbank;
//	}
//
//	public WebElement getCheckoutInputPasswordClienteTransbank() {
//		return checkoutInputPasswordClienteTransbank;
//	}
//
//	public void setCheckoutInputPasswordClienteTransbank(WebElement checkoutInputPasswordClienteTransbank) {
//		this.checkoutInputPasswordClienteTransbank = checkoutInputPasswordClienteTransbank;
//	}
//
//	public WebElement getCheckoutBtnAceptarTransbank() {
//		return checkoutBtnAceptarTransbank;
//	}
//
//	public void setCheckoutBtnAceptarTransbank(WebElement checkoutBtnAceptarTransbank) {
//		this.checkoutBtnAceptarTransbank = checkoutBtnAceptarTransbank;
//	}
//
//	public WebElement getCheckoutSelectOpcionComprarTransbank() {
//		return checkoutSelectOpcionComprarTransbank;
//	}
//
//	public void setCheckoutSelectOpcionComprarTransbank(WebElement checkoutSelectOpcionComprarTransbank) {
//		this.checkoutSelectOpcionComprarTransbank = checkoutSelectOpcionComprarTransbank;
//	}
	...
	public WebElement getCheckoutBtnRealizarPedidoCreditCard() {
		return checkoutBtnRealizarPedidoCreditCard;
	}

	public void setCheckoutBtnRealizarPedidoCreditCard(WebElement checkoutBtnRealizarPedidoCreditCard) {
		this.checkoutBtnRealizarPedidoCreditCard = checkoutBtnRealizarPedidoCreditCard;
	}
	...
	public List<WebElement> getCheckOutListTarjetas() {
		return checkOutListTarjetas;
	}

	public void setCheckOutListTarjetas(List<WebElement> checkOutListTarjetas) {
		this.checkOutListTarjetas = checkOutListTarjetas;
	}
	...
	public WebElement getCheckoutBtnRealizarPedidoCencoCard() {
		return checkoutBtnRealizarPedidoCencoCard;
	}

	public void setCheckoutBtnRealizarPedidoCencoCard(WebElement checkoutBtnRealizarPedidoCencoCard) {
		this.checkoutBtnRealizarPedidoCencoCard = checkoutBtnRealizarPedidoCencoCard;
	}	
